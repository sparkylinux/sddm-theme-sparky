% sddm-theme2-sparky(SECTION) | User Commands
%
% "September  9 2025"
...
sddm-theme2-sparky - program to do something

# SYNOPSIS

**sddm-theme2-sparky** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**sddm-theme2-sparky** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **sddm-theme2-sparky** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**sddm-theme2-sparky** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    sddm-theme2-sparky. See **foo.conf**(5) for further details.
...
**sddm-theme2-sparky** provides some return codes, that can be used in scripts:
